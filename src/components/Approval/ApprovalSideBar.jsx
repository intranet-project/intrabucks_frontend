...
const ApprovalSideBar = ({ isOpen, isClose }) => {
    ...
    const getSession = async () => {
        try {
            const response = await axios.get('http://localhost:9000/api/v1/intrabucks/approval1/session', {
                headers: {
                    'Authorization': token
                }
            });
    ...
    useEffect(() => {
        ...
        if (lengthOfArray === 2) {
            ...
            //기안자 도장 위치
            const writerStamp =
                `<table id="approvalLineTable1" style="float: left; width: 30px; border-collapse: collapse; margin-left: auto; margin-right: 3px;">
                        <tr id="tr_position1">
...
`;
            ...
            $("#approvalLinePosition").after(writerStamp + approval1Stamp + approval2Stamp + approval3Stamp);
